...
*/
	...
	$db['dev']['password'] = "";
	$db['dev']['database'] = "thetoiletproject";
	...
	$db['prod']['hostname'] = "mysql.thetoiletproject.com";
	$db['prod']['username'] = "thetoiletproject";
	$db['prod']['password'] = "basededatos";
	$db['prod']['database'] = "thetoiletproject";
